...
;; constant.character, constant.other {'foreground': '#C7EB37'}
...
(deftheme sidewalk-chalk-green-mod
  "Sidewalk Chalk Green Mod emacs theme autoconverted from the textMate theme by unknown")
(custom-theme-set-faces
  'sidewalk-chalk-green-mod
...
(provide-theme 'sidewalk-chalk-green-mod)
